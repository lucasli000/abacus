...
impl ToolAgentRegistry {
    ...
    pub fn register_builtins(&mut self) {
        ...
        self.register(ToolAgentDef {
            ...
            icon: "▸".into(),
            tool_filter: [
                "fs_read", "fs_read_multiple", "fs_ls", "fs_search", "fs_tree", "fs_info",
                "fs_grep", "fs_cwd", "fs_status",
                "cg_query", "cg_graph", "cg_analyze", "cg_index",
                "db_query", "db_read_records", "db_list_tables", "db_table_schema", "db_info",
                "kb_query", "kb_search",
                "lsp_document_symbol", "lsp_workspace_symbol", "lsp_goto_definition",
        ...
        self.register(ToolAgentDef {
            ...
            icon: "⚙".into(),
            tool_filter: [
                "fs_write", "fs_edit", "fs_read", "fs_search", "fs_ls",
                "fs_mkdir", "fs_move", "bash_exec", "fs_grep",
                "lsp_document_symbol", "lsp_goto_definition", "lsp_find_references",
            ].iter().map(|s| s.to_string()).collect(),
            priority: 10,
