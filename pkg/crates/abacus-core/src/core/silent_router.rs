    ...
    pub fn new() -> Self {
        Self {
            ...
            tool_domain_map: vec![
                ...
                (ToolId("filengine_web_fetch".into()), vec![5]),
                (ToolId("filengine_web_search".into()), vec![5]),
            ...
            tool_action_map: vec![
                ...
                (ToolId("filengine_web_fetch".into()), vec![ActionType::Read, ActionType::Search]),
                (ToolId("filengine_web_search".into()), vec![ActionType::Search]),
